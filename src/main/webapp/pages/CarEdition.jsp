...
<div align="center" class="carEdition col-lg-8">
    <form:form class="form" modelAttribute="car" method="post" action="/car/save">
        <div class="form-group">
            ...
            <form:label for="model" class="text-right col-sm-3" path="model" modelAttribute="car" >Car model:</form:label>
            <div class="col-sm-9">
        ...
        <div class="form-group">
            <form:label for="productionDate" class="text-right col-sm-3" path="productionDate" >Production date:</form:label>
            <div class="col-sm-9">
        ...
        <div class="form-group">
            <form:label for="manufacturerEmail" class="text-right col-sm-3" path="manufacturerEmail">Manufacturer E-mail:</form:label>
            <div class="col-sm-9">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <form:input type="number" step="any" class="form-control" name="price" id="price" placeholder="Enter price"
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-8">
                <label>
                    <select name="motorShow.id" size="1" Class="select"  <c:if test="${car.motorShow.id > 0 && id >0 }">hidden</c:if>>
                        <option value="${car.motorShow.id}" selected="selected" disabled="disabled">Select motor show</option>
